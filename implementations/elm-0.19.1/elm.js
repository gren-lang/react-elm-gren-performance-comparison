...
var $author$project$Todo$emptyModel = {a: _List_Nil, u: '', I: 0, K: 'All'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Todo$init = _Utils_Tuple2($author$project$Todo$emptyModel, $elm$core$Platform$Cmd$none);
...
var $author$project$Todo$focus = _Platform_outgoingPort('focus', $elm$json$Json$Encode$string);
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Todo$newEntry = F2(
	function (desc, id) {
		return {i: false, D: desc, L: false, g: id};
	});
		...
		switch (msg.$) {
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: $elm$core$String$isEmpty(model.u) ? model.a : _Utils_ap(
								model.a,
								_List_fromArray(
									[
										A2($author$project$Todo$newEntry, model.u, model.I)
									])),
							u: '',
							I: model.I + 1
						}),
			...
			case 2:
				...
				var updateEntry = function (t) {
					return _Utils_eq(t.g, id) ? _Utils_update(
						t,
						{L: isEditing}) : t;
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: A2($elm$core$List$map, updateEntry, model.a)
						}),
					$author$project$Todo$focus(
...
var $author$project$Todo$viewControls = F2(
	function (visibility, entries) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Todo$viewControlsCount(entriesLeft),
					$author$project$Todo$viewControlsFilters(visibility),
					$author$project$Todo$viewControlsClear(entriesCompleted)
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('completed', todo.i),
						_Utils_Tuple2('editing', todo.L)
					]))
			]),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$checked(todo.i),
								$elm$html$Html$Events$onClick(
								A2($author$project$Todo$Check, todo.g, !todo.i))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$label,
						_List_fromArray(
							[
								...
								A2($author$project$Todo$EditingEntry, todo.g, true))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(todo.D)
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$Todo$Delete(todo.g))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(todo.D),
						$elm$html$Html$Attributes$name('title'),
						$elm$html$Html$Attributes$id(
						'todo-' + $elm$core$String$fromInt(todo.g)),
						$elm$html$Html$Events$onInput(
						$author$project$Todo$UpdateEntry(todo.g)),
						$elm$html$Html$Events$onBlur(
						A2($author$project$Todo$EditingEntry, todo.g, false)),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Todo$viewInput(model.u),
						A2($author$project$Todo$viewEntries, model.K, model.a),
						A2($author$project$Todo$viewControls, model.K, model.a)
					])),
...
var $author$project$Todo$main = $elm$browser$Browser$element(
	{
		...
		aJ: $author$project$Todo$update,
		aK: $author$project$Todo$view
	});
