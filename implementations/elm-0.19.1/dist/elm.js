...
var $author$project$Main$emptyModel = {a: _List_Nil, r: '', C: 0, E: 'All'};
...
var $author$project$Main$newEntry = F2(
	function (desc, id) {
		return {h: false, z: desc, G: false, f: id};
	});
		...
		switch (msg.$) {
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: $elm$core$String$isEmpty(model.r) ? model.a : _Utils_ap(
								model.a,
								_List_fromArray(
									[
										A2($author$project$Main$newEntry, model.r, model.C)
									])),
							r: '',
							C: model.C + 1
						}),
			...
			case 2:
				...
				var updateEntry = function (t) {
					return _Utils_eq(t.f, id) ? _Utils_update(
						t,
						{G: isEditing}) : t;
				};
...
var $author$project$Main$DeleteComplete = {$: 6};
...
var $author$project$Main$viewControls = F2(
	function (visibility, entries) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Main$viewControlsCount(entriesLeft),
					$author$project$Main$viewControlsFilters(visibility),
					$author$project$Main$viewControlsClear(entriesCompleted)
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('completed', todo.h),
						_Utils_Tuple2('editing', todo.G)
					]))
			]),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$checked(todo.h),
								$elm$html$Html$Events$onClick(
								A2($author$project$Main$Check, todo.f, !todo.h))
							]),
						_List_Nil),
						A2(
						$elm$html$Html$label,
						_List_fromArray(
							[
								...
								A2($author$project$Main$EditingEntry, todo.f, true))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(todo.z)
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(
								$author$project$Main$Delete(todo.f))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(todo.z),
						$elm$html$Html$Attributes$name('title'),
						$elm$html$Html$Attributes$id(
						'todo-' + $elm$core$String$fromInt(todo.f)),
						$elm$html$Html$Events$onInput(
						$author$project$Main$UpdateEntry(todo.f)),
						$elm$html$Html$Events$onBlur(
						A2($author$project$Main$EditingEntry, todo.f, false)),
...
var $author$project$Main$viewKeyedEntry = function (todo) {
	return _Utils_Tuple2(
		$elm$core$String$fromInt(todo.f),
		$author$project$Main$viewEntry(todo));
};
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewInput(model.r),
				A2($author$project$Main$viewEntries, model.E, model.a),
				A2($author$project$Main$viewControls, model.E, model.a)
			]));
};
										...
										return A2(
											...
											function (entries) {
												return $elm$json$Json$Decode$succeed(
													{a: entries, r: field, C: uid, E: visibility});
											},
											A2(
																	...
																	return A2(
																		...
																		function (description) {
																			return A2(
																				...
																				function (completed) {
																					return $elm$json$Json$Decode$succeed(
																						{h: completed, z: description, G: editing, f: id});
																				},
