  ...
  return _Platform_initialize(
    ...
    function (sendToApp, initialModel) {
      ...
      return _Browser_makeAnimator(initialModel, function (model) {
        ...
        var doc = view(model);
        var nextNode = _VirtualDom_node("body")([])(doc.bb);
        var patches = _VirtualDom_diff(currNode, nextNode);
        ...
        title !== doc.a3 &&
          (_VirtualDom_doc.title = title = doc.a3);
      });
    }
  );
});
...
function _Browser_visibilityInfo() {
  return typeof _VirtualDom_doc.hidden !== "undefined"
    ? { bk: "hidden", bd: "visibilitychange" }
    : typeof _VirtualDom_doc.mozHidden !== "undefined"
    ? { bk: "mozHidden", bd: "mozvisibilitychange" }
    : typeof _VirtualDom_doc.msHidden !== "undefined"
    ? { bk: "msHidden", bd: "msvisibilitychange" }
    : typeof _VirtualDom_doc.webkitHidden !== "undefined"
    ? { bk: "webkitHidden", bd: "webkitvisibilitychange" }
    : { bk: "hidden", bd: "visibilitychange" };
}
...
function _Debug_toAnsiString(ansi, value) {
  ...
  if (
    ...
    return _Debug_toAnsiString(ansi, value.E.slice(0, value.Z));
  }
...
function _Debug_regionToString(region) {
  if (region.a1.I === region.aC.I) {
    return "on line " + region.a1.I;
  }
  return (
    "on lines " + region.a1.I + " through " + region.aC.I
  );
}
...
var _Array_fromBuilder = function (builder) {
  var result = builder.E;

  if (builder.G) {
    result = result.slice(0, builder.Z);
  } else {
    builder.G = true;
    result.length = builder.Z;
  }
    ...
    case 7:
      ...
      for (var key in value) {
        if (value.hasOwnProperty(key)) {
          ...
          keyValuePairs.push({ aj: key, a5: result.a });
        }
      }
...
function _Platform_initialize(
  ...
  var model = initPair.l;
  var stepper = stepperBuilder(sendToApp, model);
  var ports = _Platform_setupEffects(managers, sendToApp);

  function sendToApp(msg, viewMetadata) {
    var pair = A2(update, msg, model);
    stepper((model = pair.l), viewMetadata);
...
function _VirtualDom_makeCallback(eventNode, initialHandler) {
  function callback(event) {
    ...
    var value = result.a;
    var message = !tag ? value : value.t;
    var stopPropagation =
      tag == 1 || tag == 3 ? value.M : false;
    var currentEventNode =
      (stopPropagation && event.stopPropagation(),
      (tag == 2 || tag == 3 ? value.J : false) &&
        event.preventDefault(),
      eventNode);
    var tagger;
    var i;
...
function _VirtualDom_diffKeyedKids(xParent, yParent, patches, rootIndex) {
  ...
  while (xIndex < xLen && yIndex < yLen) {
    ...
    if (xNext) {
      var xNextKey = xNext.aj;
      var xNextNode = xNext.aj;
      oldMatch = yKey === xNextKey;
    }

    if (yNext) {
      var yNextKey = yNext.aj;
      var yNextNode = yNext.aj;
  ...
  while (xIndex < xLen) {
    ...
    var x = xKids[xIndex];
    var xNode = x.bu;
    _VirtualDom_removeNode(changes, localPatches, x.aj, xNode, index);
    index += xNode.b || 0;
    xIndex++;
  }
...
function _VirtualDom_addDomNodesHelp(
  ...
  for (var j = 0; j < vKids.length; j++) {
    low++;
    var vKid = tag === 1 ? vKids[j] : vKids[j].bu;
...
var $gren_lang$url$Url$chompBeforePath$ = function(protocol, path, params, frag, str) {
	if ($gren_lang$core$String$isEmpty(str) || A2($gren_lang$core$String$contains, '@', str)) {
		...
		switch (_v0.length) {
			case 0:
				return $gren_lang$core$Maybe$Just({ ai: frag, aH: str, al: path, aS: $gren_lang$core$Maybe$Nothing, aW: protocol, an: params });
			case 1:
				var i = _v0[0];
				...
				if (_v1.$ === 1) {
					...
					var port_ = _v1;
					return $gren_lang$core$Maybe$Just({ ai: frag, aH: $gren_lang$core$String$left$(i, str), al: path, aS: port_, aW: protocol, an: params });
				}
			default:
				return $gren_lang$core$Maybe$Nothing;
		}
...
var $gren_lang$url$Url$fromString = function(str) {
	return A2($gren_lang$core$String$startsWith, 'http://', str) ? $gren_lang$url$Url$chompAfterProtocol$(0, $gren_lang$core$String$dropLeft$(7, str)) : (A2($gren_lang$core$String$startsWith, 'https://', str) ? $gren_lang$url$Url$chompAfterProtocol$(1, $gren_lang$core$String$dropLeft$(8, str)) : $gren_lang$core$Maybe$Nothing);
};
...
var $author$project$Todo$emptyModel = { b: [  ], B: '', aa: 0, ac: 'All' };
...
var $author$project$Todo$init = { h: $gren_lang$core$Platform$Cmd$none, l: $author$project$Todo$emptyModel };
...
var $author$project$Todo$newEntry$ = function(desc, id) {
	return { i: false, Q: desc, ae: false, e: id };
};
...
var $author$project$Todo$update$ = function(msg, model) {
	switch (msg.$) {
		case 0:
			return { h: $gren_lang$core$Platform$Cmd$none, l: model };
		case 4:
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { b: $gren_lang$core$String$isEmpty(model.B) ? model.b : _Utils_ap(model.b, [ $author$project$Todo$newEntry$(model.B, model.aa) ]), B: '', aa: model.aa + 1 }) };
		case 1:
			var str = msg.a;
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { B: str }) };
		case 2:
			var id = msg.a;
			var isEditing = msg.b;
			var updateEntry = function(t) {
				return _Utils_eq(t.e, id) ? _Utils_update(t, { ae: isEditing }) : t;
			};
			return { h: $author$project$Todo$focus('#todo-' + $gren_lang$core$String$fromInt(id)), l: _Utils_update(model, { b: A2($gren_lang$core$Array$map, updateEntry, model.b) }) };
		case 3:
			var id = msg.a;
			var task = msg.b;
			var updateEntry = function(t) {
				return _Utils_eq(t.e, id) ? _Utils_update(t, { Q: task }) : t;
			};
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { b: A2($gren_lang$core$Array$map, updateEntry, model.b) }) };
		case 5:
			var id = msg.a;
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { b: A2($gren_lang$core$Array$filter, function(t) {
						return !_Utils_eq(t.e, id);
					}, model.b) }) };
		case 6:
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { b: A2($gren_lang$core$Array$filter, $gren_lang$core$Basics$composeL$($gren_lang$core$Basics$not, function ($) {
							return $.i;
						}), model.b) }) };
		case 7:
			var id = msg.a;
			...
			var updateEntry = function(t) {
				return _Utils_eq(t.e, id) ? _Utils_update(t, { i: isCompleted }) : t;
			};
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { b: A2($gren_lang$core$Array$map, updateEntry, model.b) }) };
		case 8:
			var isCompleted = msg.a;
			var updateEntry = function(t) {
				return _Utils_update(t, { i: isCompleted });
			};
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { b: A2($gren_lang$core$Array$map, updateEntry, model.b) }) };
		default:
			var visibility = msg.a;
			return { h: $gren_lang$core$Platform$Cmd$none, l: _Utils_update(model, { ac: visibility }) };
	}
};
...
var $author$project$Todo$infoFooter = A2($gren_lang$browser$Html$footer, [ $gren_lang$browser$Html$Attributes$class('info') ], [ A2($gren_lang$browser$Html$p, [  ], [ $gren_lang$browser$Html$text('Double-click to edit a todo') ]), A2($gren_lang$browser$Html$p, [  ], [ $gren_lang$browser$Html$text('Written by '), A2($gren_lang$browser$Html$a, [ $gren_lang$browser$Html$Attributes$href('https://github.com/evancz') ], [ $gren_lang$browser$Html$text('Evan Czaplicki') ]) ]), A2($gren_lang$browser$Html$p, [  ], [ $gren_lang$browser$Html$text('Part of '), A2($gren_lang$browser$Html$a, [ $gren_lang$browser$Html$Attributes$href('http://todomvc.com') ], [ $gren_lang$browser$Html$text('TodoMVC') ]) ]) ]);
...
var $gren_lang$browser$Html$Attributes$classList = function(classes) {
	return $gren_lang$browser$Html$Attributes$class(A2($gren_lang$core$String$join, ' ', A2($gren_lang$core$Array$map, function ($) {
					return $.ad;
				}, A2($gren_lang$core$Array$filter, function ($) {
						return $.af;
					}, classes))));
};
...
var $author$project$Todo$visibilitySwap$ = function(uri, visibility, actualVisibility) {
	return A2($gren_lang$browser$Html$li, [ $gren_lang$browser$Html$Events$onClick($author$project$Todo$ChangeVisibility(visibility)) ], [ A2($gren_lang$browser$Html$a, [ $gren_lang$browser$Html$Attributes$href(uri), $gren_lang$browser$Html$Attributes$classList([ { ad: 'selected', af: _Utils_eq(visibility, actualVisibility) } ]) ], [ $gren_lang$browser$Html$text(visibility) ]) ]);
};
...
var $author$project$Todo$viewControls$ = function(visibility, entries) {
	var entriesCompleted = $gren_lang$core$Array$length(A2($gren_lang$core$Array$filter, function ($) {
				return $.i;
			}, entries));
...
var $author$project$Todo$Check$ = function (a, b) {
	return { $: 7, a: a, b: b };
};
var $author$project$Todo$Check = F2($author$project$Todo$Check$);
var $author$project$Todo$Delete = function (a) {
	return { $: 5, a: a };
};
var $author$project$Todo$EditingEntry$ = function (a, b) {
	return { $: 2, a: a, b: b };
};
var $author$project$Todo$EditingEntry = F2($author$project$Todo$EditingEntry$);
var $author$project$Todo$UpdateEntry$ = function (a, b) {
	return { $: 3, a: a, b: b };
};
var $author$project$Todo$UpdateEntry = F2($author$project$Todo$UpdateEntry$);
...
var $author$project$Todo$viewEntry = function(todo) {
	return A2($gren_lang$browser$Html$li, [ $gren_lang$browser$Html$Attributes$classList([ { ad: 'completed', af: todo.i }, { ad: 'editing', af: todo.ae } ]) ], [ A2($gren_lang$browser$Html$div, [ $gren_lang$browser$Html$Attributes$class('view') ], [ A2($gren_lang$browser$Html$input, [ $gren_lang$browser$Html$Attributes$class('toggle'), $gren_lang$browser$Html$Attributes$type_('checkbox'), $gren_lang$browser$Html$Attributes$checked(todo.i), $gren_lang$browser$Html$Events$onClick($author$project$Todo$Check$(todo.e, !todo.i)) ], [  ]), A2($gren_lang$browser$Html$label, [ $gren_lang$browser$Html$Events$onDoubleClick($author$project$Todo$EditingEntry$(todo.e, true)) ], [ $gren_lang$browser$Html$text(todo.Q) ]), A2($gren_lang$browser$Html$button, [ $gren_lang$browser$Html$Attributes$class('destroy'), $gren_lang$browser$Html$Events$onClick($author$project$Todo$Delete(todo.e)) ], [  ]) ]), A2($gren_lang$browser$Html$input, [ $gren_lang$browser$Html$Attributes$class('edit'), $gren_lang$browser$Html$Attributes$value(todo.Q), $gren_lang$browser$Html$Attributes$name('title'), $gren_lang$browser$Html$Attributes$id('todo-' + $gren_lang$core$String$fromInt(todo.e)), $gren_lang$browser$Html$Events$onInput($author$project$Todo$UpdateEntry(todo.e)), $gren_lang$browser$Html$Events$onBlur($author$project$Todo$EditingEntry$(todo.e, false)), $author$project$Todo$onEnter($author$project$Todo$EditingEntry$(todo.e, false)) ], [  ]) ]);
};
...
var $author$project$Todo$view = function(model) {
	return A2($gren_lang$browser$Html$div, [ $gren_lang$browser$Html$Attributes$class('todomvc-wrapper'), A2($gren_lang$browser$Html$Attributes$style, 'visibility', 'hidden') ], [ A2($gren_lang$browser$Html$section, [ $gren_lang$browser$Html$Attributes$class('todoapp') ], [ $author$project$Todo$viewInput(model.B), $author$project$Todo$viewEntries$(model.ac, model.b), $author$project$Todo$viewControls$(model.ac, model.b) ]), $author$project$Todo$infoFooter ]);
};
var $author$project$Todo$main = $gren_lang$browser$Browser$element({ bn: function(_v0) {
		return $author$project$Todo$init;
	}, bJ: function(_v1) {
		return $gren_lang$core$Platform$Sub$none;
	}, bL: $author$project$Todo$update, bN: $author$project$Todo$view });
_Platform_export({'Todo':{'init':$author$project$Todo$main($gren_lang$core$Json$Decode$succeed({  }))(0)}});}(this.module ? this.module.exports : this));